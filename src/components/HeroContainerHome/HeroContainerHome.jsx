...
const HeroContainerHome = () => {
  ...
  return (
    <section className="bg-green-800 text-white p-4 md:p-8 lg:p-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg md:text-xl lg:text-2xl italic">The Celebration Begins</p>
        </div>
        
        <div className="text-center mb-8">
          <h3 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">PRICE LIST - 2025</h3>
          <p className="text-base md:text-lg lg:text-xl">
            ALL TYPES OF FANCY CRACKERS & GIFT BOXES AVAILABLE
          </p>
        </div>
        
        <div className="bg-green-900 text-white p-4 rounded-lg shadow-lg mb-8">
